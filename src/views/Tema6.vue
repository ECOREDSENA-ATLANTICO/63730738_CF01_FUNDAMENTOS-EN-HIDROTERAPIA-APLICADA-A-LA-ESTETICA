      ...
      .col-lg-8
        SlyderF.custom(columnas="col-lg-6 col-md-6")
          .tarjeta.tarjeta--slyder.p-4.mb-0(style="background: #F5F5F5; align-content: center")
            ...
            p.text-center El aumento de calor genera vasodilatación, acelerando la circulación sanguínea y produciendo sudoración con la consecuente disminución de toxinas del tejido, aumento de la elasticidad.

          .tarjeta.tarjeta--slyder.p-4.mb-0(style="background: #F5F5F5; align-content: center")
            h4.text-center Sistema respiratorio
            p.text-center La aplicación de agua caliente produce movimientos respiratorios rápidos y superficiales generando mayor eliminación de anhídrido carbónico.
          ...
          .tarjeta.tarjeta--slyder.p-4.mb-0(style="background: #F5F5F5; align-content: center")
            ...
            p.text-center La actividad metabólica del estómago y los intestinos aumenta con agua muy caliente, así como también aumenta la secreción biliar.

          .tarjeta.tarjeta--slyder.p-4.mb-0(style="background: #F5F5F5; align-content: center")
            h4.text-center Sistema urogenital
            p.text-center Aumento de diuresis o eliminación de líquidos, disminución de la inflamación en órganos urogenitales.

          .tarjeta.tarjeta--slyder.p-4.mb-0(style="background: #F5F5F5; align-content: center")
            h4.text-center Sistema muscular
            p.text-center Fortalecimiento de los músculos y en aplicaciones cortas disminuye la fatiga o cansancio de los mismos, disminución del tono aplicaciones prolongadas.
      ...
      .col-lg-8
        SlyderF.custom(columnas="col-lg-6 col-md-6")
          .tarjeta.tarjeta--slyder.p-4.mb-0(style="background:#EBF8FC; align-content: center")
            h4.text-center Efectos en la piel
            p.text-center La aplicación de agua fría produce vasoconstricción, analgesia, disminución de edemas.

          .tarjeta.tarjeta--slyder.p-4.mb-0(style="background:#EBF8FC; align-content: center")
            h4.text-center Sistema respiratorio
            p.text-center La aplicación de agua fría produce movimientos respiratorios rápidos y superficiales generando mayor eliminación de anhídrido carbónico.

          .tarjeta.tarjeta--slyder.p-4.mb-0(style="background:#EBF8FC; align-content: center")
            h4.text-center Sistema circulatorio
            p.text-center Disminución de la actividad cardiaca, bradicardia y aumento de la presión arterial.

          .tarjeta.tarjeta--slyder.p-4.mb-0(style="background:#EBF8FC; align-content: center")
            h4.text-center Sistema digestivo
            p.text-center Disminución de los movimientos peristálticos y de los órganos digestivos, la aplicación de agua fría aumenta la secreción de la bilis.
          
          .tarjeta.tarjeta--slyder.p-4.mb-0(style="background:#EBF8FC; align-content: center")
            h4.text-center Sistema urogenital
            p.text-center Las aplicaciones de corta duración favorecen la diuresis o eliminación de líquidos.
          .tarjeta.tarjeta--slyder.p-4.mb-0(style="background:#EBF8FC; align-content: center")
            h4.text-center Sistema muscular
            p.text-center Aumenta el tono y la actividad muscular, disminuye la flacidez.
